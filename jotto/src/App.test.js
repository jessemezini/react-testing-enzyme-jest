...
describe('redux properties', () => {
  ...
  it('has access to "guessedWords" state', () => {
    ...
    const successProp = wrapper.instance().props.guessedWords;

    expect(successProp).toBe(guessedWords);
  });

  it('"getSecretWord" action creator is a func. on the props', () => {
    const wrapper = setup();
...
it('"getSecretWord" runs on App mout', () => {
  ...
  // set up app comp. with getSecretWordMock as the getSecretWord prop
